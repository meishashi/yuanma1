...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://weixin.dingzhishipu.com/youxi/games/duimutou/icon.png",
		url: "http://weixin.dingzhishipu.com/youxi/games/duimutou/",
		title: "堆木头，简单的不得了，好玩的停不下",
		desc: "玩法简单，但是玩的是技巧，反应，没有最高只有更高，来挑战下--关注bluesea游戏:bluesea"
	};
...
function updateShare(stscore) {
	imgUrl = 'http://weixin.dingzhishipu.com/youxi/games/duimutou/i/icon.png';
	lineLink = 'http://weixin.dingzhishipu.com/youxi/games/duimutou';
