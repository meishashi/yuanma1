        ...
        init: function() {
            ...
            e.run(function() {
                ...
                if(e.buttonLayout.released("moregame")) {
                    location.href="http://weixin.dingzhishipu.com/youxi";
                }
            ...
            var l = {
                ...
                h = function() {
                    ...
                    n == null && (n = "0"), l.bestTime = parseInt(n), l.time > l.bestTime && e.localStorage.setItem("NotDieAnyoneBestTime" + l.module, l.time.toString()), submitScore(l.module, l.time * (l.module - 1))
                }
        }
    }
}), require.config({
