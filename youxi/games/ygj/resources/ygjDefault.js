...
var rankurl = 'http://weixin.dingzhishipu.com/youxi/games/ygj/index.html';
window.shareData = {
    "imgUrl": "http://weixin.dingzhishipu.com/youxi/games/ygj/resources/logo_small.jpg",
    "timeLineLink": "http://weixin.dingzhishipu.com/youxi/games/ygj/index.html",
...
function clickMore(){
			if((window.location+"").indexOf("zf",1)>0){
				window.location = "http://weixin.dingzhishipu.com/youxi/games/ygj/index.html";
			 }
			 else{
				goHome();
			 }
