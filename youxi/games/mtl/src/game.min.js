	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://weixin.dingzhishipu.com/youxi",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://weixin.dingzhishipu.com/youxi";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://weixin.dingzhishipu.com/youxi";
y.url = function() {
	return "http://weixin.dingzhishipu.com/youxi?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://weixin.dingzhishipu.com/youxi/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("bluesea游戏—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("bluesea游戏", "Arial", 12);
