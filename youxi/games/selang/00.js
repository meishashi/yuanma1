$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://weixin.dingzhishipu.com/youxi/games/';
...
var mebtnopenurl = 'http://weixin.dingzhishipu.com/youxi/';
window.shareData = {
    "imgUrl": "http://weixin.dingzhishipu.com/youxi/games/selang/icon.png",
    "timeLineLink": "http://weixin.dingzhishipu.com/youxi/games/selang/",
    "tTitle": "小心色狼-bluesea游戏游戏",
...
function successHandler(m, t) {
    ...
    document.title = t / 1000 + "秒！bluesea游戏游戏《小心色狼》我刚通过了！你敢不敢和我比一下？";
...
function failHandler(t) {
    ...
    if (helpCount > 2) {
        if (confirm("是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？")) {
            location.href = "new.bluesea.com/youxiss"
        };
        helpCount = 0
    }
};
...
function moreHandler() {
    window.location.href = "http://weixin.dingzhishipu.com/youxi/"
};
function dp_shareHelp(t) {
    $("#share img").attr("src", "share.png");
    document.title = "我花了" + t / 1000 + "秒！bluesea游戏游戏《小心色狼》还没解开！快来帮帮我吧！";
