...
shareData = {
    imgUrl: "http://weixin.dingzhishipu.com/youxi/games/zhaonimei/zhaonimei.jpg",
    timeLineLink: "http://weixin.dingzhishipu.com/youxi/games/zhaonimei/",
...
function() {
    ...
    c = {
        ...
        start: function() {
            if(this.lv==-1) shareData.totalWazi=0;
            this.time > 5 && b.time.removeClass("danger"),
            b.dialog.hide(),
            this._pause = !1,
            //shareData.totalWazi = 0,
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://weixin.dingzhishipu.com/youxi/").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://weixin.dingzhishipu.com/youxi/").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,
            ...
            function() {
                ...
                function() {
                    ...
                    //var a = Game.lastLv > 0 ? h.share_txt1 + (Game.lastLv + 1) + h.share_txt2 + Game.lastGamePercent + h.share_txt3 + Game.lastGameTxt + h.share_txt4: shareData.tTitle;
                    var a = Game.lastLv > 0 ? h.share_txt1 + (shareData.totalWazi + 1) + h.share_txt2 + (Game.lastLv+1) + h.share_txt3 + Game.lastGameTxt + h.share_txt4: shareData.tTitle;
...
function() {
    ...
    e = {
        ...
        render: function(e, f) {
            ...
            a.find(b).css("background-color", i[1]).data("type", "b").html('<span style="padding:0px;border:0;font-size:'+size+'px;line-height:'+size+'px;width:100%;height:100%" >袜</span>'),
            a.find(b).eq(h).css("background-color", i[1]).data("type", "a").html('<span style="padding:0px;border:0;font-size:'+size+'px;line-height:'+size+'px;width:100%;height:100%" >妹</span>')
        },
        getColor: function(a) {
