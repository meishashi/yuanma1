...
class ShipinAction extends UserAction{
	...
	public function del(){
		...
		if(D(MODULE_NAME)->where($where)->delete()){
				M('Keyword')->where(array('pid'=>$where['id'],'token'=>session('token'),'module'=>'Shipin'))->delete();
