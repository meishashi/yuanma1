	            ...
	            <table class="table table-striped table-bordered" style="margin-top:10px;" id="set_table">
				  <tbody>
				    ...
				    <tr> 
				      ...
				      <td><input type="text" name="email_server" value="<?php echo C('email_server');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;</span>
					  </td>
				    </tr>
					 <tr> 
				      <td><strong>服务器端口：</strong></td>
				      <td><input type="text" name="email_port" value="<?php echo C('email_port');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;</span>
					  
				    </tr>
					<!--<tr> 
				      <td><strong>发件人地址：</strong></td>
				      <td><input type="text" name="email_form" value="<?php echo C('email_form');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;一般不超过80个字符</span>
				    </tr>-->
					 <tr> 
				      <td><strong> 用户名：</strong></td>
				      <td><input type="text" name="email_user" value="<?php echo C('email_user');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;</span>
				    </tr> 
					<tr> 
				      <td><strong>密  码：</strong></td>
				      <td><input type="text" name="email_pwd" value="<?php echo C('email_pwd');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;</span>
				    </tr>
					<tr> 
				      <td><strong>密码找回标题：</strong></td>
				      <td><input type="text" name="pwd_email_title" value="<?php echo C('pwd_email_title');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;</span>
				    </tr>	
					<tr> 
				      <td><strong>密码找回主题：</strong></td>
				      <td><input type="text" name="pwd_email_content" value="<?php echo C('pwd_email_content');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;</span>
				    </tr>
