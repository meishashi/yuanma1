    ...
    <div class="row">
	  ...
	  <tr>
	    ...
	    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td align='center' style="display:none"><?php echo ($vo["usenum"]); ?></td>
				<td align='center' style="display:none"><?php if(($vo["status"]) == "1"): ?><font color="red">√</font><?php else: ?><font color="blue">×</font><?php endif; ?> 
				</td>
				<td align='center'><a href="javascript:void(0)" onclick="if(confirm('确定删除吗')){location.href='<?php echo U('Token/del/',array('id'=>$vo['id']));?>'}">删除</a>
				</td>
