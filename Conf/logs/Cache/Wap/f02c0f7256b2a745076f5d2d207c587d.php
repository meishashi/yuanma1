...
<script>
// <?php if($isLotteryButNotInputTel == 1): ?>// lq({sn:'<?php echo ($record["sn"]); ?>',prize_type:'<?php echo ($record["prize"]); ?>'});
//<?php endif; ?>
// <?php if($isLotteryButNotSend == 1): ?>// sqdh({sn:'<?php echo ($record["sn"]); ?>',prize_type:'<?php echo ($record["prize"]); ?>'});
//<?php endif; ?>
	// function sqdh(arg){
	// 	var d1 = new iDialog();
	// 	d1.open({
...
window.shareData = {  
            ...
            "tContent": "<?php echo (substr($lottery["info"],0,60)); ?>"
};
</script>
