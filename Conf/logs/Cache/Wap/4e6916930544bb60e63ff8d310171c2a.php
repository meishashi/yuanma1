...
<section>
  <nav class="nav_for_list_ul">
    <div class="ofh">
      <ul>
			<?php $__FOR_START_28064__=1;$__FOR_END_28064__=count($info);for($i=$__FOR_START_28064__;$i < $__FOR_END_28064__;$i+=1){ ?><li <?php if($i == 4): ?>class="on"<?php endif; ?>></li><?php } ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo ($staticPath); ?>/tpl/static/home/css/reset.css" media="all">
...
<?php elseif($home['start'] == 2): ?>
		...
		*{
		...
		.overlay{
			height:100%;
			background:rgba(89,198,255,0.8);
			position:absolute;
			z-index:100;
			width:100%;
			left:0;
...
<?php elseif($home['start'] == 3): ?>
		...
		*{
		...
		.overlay{
			height:100%;
			background:rgba(254,235,117,0.8);
			position:absolute;
			z-index:100;
			width:100%;
			left:0;
...
<body>
	...
	<div data-role="widtet" data-widget="screen_1" class="screen_1" id="screen_1">
		...
		<div class="animation t1" id="screen_1_animation" style="display: block; top: 0px;">
			<img src="<?php echo ($home["stpic"]); ?>" style="width:100%;min-height:100%;" onload="screen_1.screenClose(event);" onerror="screen_1.screenClose(event);">
		</div>
	</div>
