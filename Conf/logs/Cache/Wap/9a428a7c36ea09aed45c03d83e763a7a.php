...
<body class="activity-lottery-winning" >
    ...
    <?php else: ?>
        ...
        <div id="outercont"  >
            <div id="outer-cont">
                <div id="outer" style="-webkit-transform: rotate(2075.9993514680145deg);"><img src="<?php echo RES;?>/css/guajiang/images/activity-lottery-5.png"></div>
            </div>
            <div id="inner-cont">
    ...
    <?php if($wecha_id != ''): ?>$("#inner").click(function() {
        ...
        $.ajax({
            url     : "/index.php?g=Wap&m=Lottery&a=getajax&token=<?php echo ($Dazpan["token"]); ?>&wecha_id=<?php echo ($wecha_id); ?>&oneid=<?php echo ($Dazpan["wecha_id"]); ?>&id=<?php echo ($Dazpan["lid"]); ?>&rid=<?php echo ($Dazpan["rid"]); ?>",
            dataType: "json",
