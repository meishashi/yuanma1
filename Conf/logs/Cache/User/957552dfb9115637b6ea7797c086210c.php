...
<div class="cLineC" style="line-height: 32px;"> <a href="<?php echo U('Business/index_add',array('token'=>$token,'type'=>$type));?>" class="btn btn-primary btn_submit  J_ajax_submit_btn">
  <?php if($type == 'fitness'): ?>添加健身中心
      <?php elseif($type == 'gover'): ?>
添加政务部门
      <?php elseif($type == 'food'): ?>
添加食品公司
    ...
    <div class="bdrcontent">
      <div id="div_ptype">
        <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
          <thead>
            <tr>
              <th style=" width:100px;">图文消息标题</th>
              <th style=" width:100px;">触发关键词</th>
              <th style=" width:100px;">图文消息封面</th>
...
<?php if(is_array($busines)): $i = 0; $__LIST__ = $busines;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
              <td><?php echo ($vo["title"]); ?></td>
              <td><?php echo ($vo["keyword"]); ?></td>
              <td><div class="cateimg"><img src="<?php echo ($vo["picurl"]); ?>" class="cateimg_small"></div></td>
              <td><?php echo ($vo["mtitle"]); ?></td>
              <td class="norightborder">
              <a href="<?php echo U('Business/index_add',array('bid'=>$vo['bid'],'type'=>$vo['type']));?>" class="btn btn-primary btn_submit  J_ajax_submit_btn">编辑</a>
              <a href="<?php echo U('Business/index_del',array('bid'=>$vo['bid'],'type'=>$vo['type']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn btn-primary btn_submit  J_ajax_submit_btn">删除</a> </td>
