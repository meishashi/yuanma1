		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
				  ...
				  <td>
					<span class="red">团购 —— 当用户输入该关键词时，将会触发此回复。</span></td>
				</tr>
				<tr>
				...
				<tr>
					<th>界面风格：</th>
					<td><select name="tplid"><option value="0" <?php if($tplid == 0): ?>selected<?php endif; ?>>蓝色淡雅</option><option value="1" <?php if($tplid == 1): ?>selected<?php endif; ?>>春意盎然</option></select></td>
				</tr>
				<th>&nbsp;</th>
					<td>
					<input type="hidden" name="keyword" value="<?php echo ($infoType["keyword"]); ?>" />
					<input type="hidden" name="infotype" value="Groupon" />
