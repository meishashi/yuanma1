...
<li class="<?php if(ACTION_NAME == 'wap_nav'): ?>selectTag<?php endif; ?> " id="tab2"><a href="<?php echo U('Market/wap_nav',array('token'=>$token,'type'=>'market'));?>">商圈首页板块设置</a></li>
  ...
  <div class="cLineB">
    <h4>商圈分类管理</h4>
     <a href="<?php echo U('Market/cate_set',array('token'=>$token));?>"  class="btn btn-primary btn_submit  J_ajax_submit_btn right" style="margin-top:-30px">
...
<thead>
<tr> <th style=" width:120px;">分类名称</th>
<th style=" width:120px;">分类简介</th>
...
<?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tbody>
            <tr>
              <td>
                <div class="cateimg" style="padding:0 5px;"><img src="<?php echo ($item["cate_pic"]); ?>" class="cateimg_small"></div>
                <?php echo ($item["cate_name"]); ?>
              </td>
              <td><?php echo ($item["cate_intro"]); ?></td>
              <td>
              ...
              <a href="<?php echo U('Market/cate_set',array('cate_id'=>$item['cate_id']));?>" >编辑</a> &nbsp;|&nbsp;
              <a href="<?php echo U('Market/cate_del',array('cate_id'=>$item['cate_id']));?>" onclick="return(confirm('确定要删除吗？'))" >删除</a> 
              </td>
            </tr>
