...
<TR>
  ...
  <TD> <a href="###" onclick="addImgMessage()" class="btn btn-primary btn_submit  J_ajax_submit_btn">添加图文消息</a>&nbsp;&nbsp;<a href="###" onclick="clearMessage()" class="btn btn-primary btn_submit  J_ajax_submit_btn">清空重选</a>
...
<tr>
	<th></th>
	<td><button type="submit" class="btn btn-primary btn_submit  J_ajax_submit_btn">保存</button>　<a href="javascript:history.go(-1);" class="btn btn-primary btn_submit  J_ajax_submit_btn">取消</a></td>
</tr>
 </tbody>
</table>	  
</form>
