...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4 class="left">团购管理 (<?php echo ($page); ?>) </h4>
...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Groupon/add',array('token'=>$token));?>" title="添加" class="btn btn-primary btn_submit  J_ajax_submit_btn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加团购</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<th width="100">原价 / 现价(元)</th>
<th width="170">关键词</th>
<th width="150">创建时间 / 截止日期</th>
<th width="90" align="center" style="text-align:center">出售数量</th>
...
<td><span style="text-decoration:line-through"><?php echo ($hostlist["oprice"]); ?></span> / <?php echo ($hostlist["price"]); ?></td>
<td><?php echo ($hostlist["keyword"]); ?></td>
<td><?php echo (date("Y-m-d",$hostlist["time"])); ?> / <?php echo (date("Y-m-d",$hostlist["endtime"])); ?></td> 
<td align="center"><?php echo ($hostlist["salecount"]); ?></td>
<td class="norightborder"><a href="<?php echo U('Groupon/set',array('id'=>$hostlist['id'],'token'=>$token));?>">修改</a> <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Groupon/del',array('id'=>$hostlist['id'],'token'=>$token));?>');">删除</a></td>
