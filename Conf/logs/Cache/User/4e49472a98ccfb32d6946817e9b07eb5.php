...
<body>
        ...
        <div class="content">
          ...
          <div class="cLine">
			...
			<a href='/index.php?g=User&m=Lottery&a=add' title='新增幸运大转盘活动' class='btn btn-primary btn_submit  J_ajax_submit_btn'><img src="<?php echo RES;?>/images/img/activity-lottery.png" class="vm" />新增幸运大转盘活动</a>
                ...
                <TR></TR>
                  ...
                  <TD>大转盘 <?php echo ($list["id"]); ?></TD>
				   ...
				   <a href="index.php?g=User&m=Lottery&a=sn&id=<?php echo ($list["id"]); ?>">SN码管理</a> 
											<a href='###' Onclick='javascript:demo("<?php echo U('Demo_img/index',array('id'=>$list['id'],'act'=>'Lottery'));?>");' title="预览">预览</a> 
