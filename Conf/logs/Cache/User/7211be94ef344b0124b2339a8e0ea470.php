...
17.朗读 朗读＋关键词　例：朗读<?php echo ($f_siteTitle); ?>多用户营销系统<br/>
18.计算器 计算器使用方法　例：计算50-50　，计算100*100<br/>
19.输入价格了解<?php echo ($f_siteTitle); ?>平台系统的价格<br/>
20.输入服务了解<?php echo ($f_siteTitle); ?>平台系统的售后服务<br/>
21.输入抽奖，即可玩幸运大抽奖<br/>
22.输入会员即可填写会员资料<br/>
...
<input type="submit" value="保存"  name="sbmt"   class="btn btn-primary btn_submit  J_ajax_submit_btn"  />　<a href="<?php echo U('Img/add');?>"  class="btn"  >切换到图文模式</a>
<div class="right"  >
<ul>
