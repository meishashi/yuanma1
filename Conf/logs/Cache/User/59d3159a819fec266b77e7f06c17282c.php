...
<!--活动开始-->
<div class="cLineB">
    <h4>编辑刮刮卡活动开始内容</h4><a href="javascript:history.go(-1);"  class="right btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px" >返回</a>
</div> 
...
<TR>
  ...
  <TD>
	<input type="text" class="px" id="keyword" value="<?php if($vo['keyword'] == ''): ?>刮刮卡<?php else: echo ($vo["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
  ...
  <TD rowspan="7" valign="top">
	  <div style="margin-left:20px">
		...
		<br /><input name="type" value="2" type="hidden"   />
		 <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',1000,500,'<?php echo ($token); ?>')" class="btn btn-primary btn_submit  J_ajax_submit_btn">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;活动开始图片
	  </div>
  </TD>
</TR>
<TR>
  ...
  <TD>
	<input type="text" class="px" id="title" value="<?php if($vo['title'] == ''): ?>刮刮卡活动开始了<?php else: echo ($vo["title"]); endif; ?>" name="title" style="width:400px" />
  	<br />
  	请不要多于50字!
  </TD>
  <TR>
  	...
  	<table class="userinfoArea" style=" margin: 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
  		<tbody>
  			<tr>
  				...
  				<td><input type="text" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): ?>刮刮卡活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:400px" />
  					<br />
  					请不要多于50字! </td>
  				<td rowspan="4" valign="top"><div style="margin-left:20px"><img  id="pic2_src" src="<?php if($vo['endpicurl'] == ''): echo ($f_siteUrl); ?>/tpl/User/default/common/images/img/activity-scratch-card-end.jpg<?php else: echo ($vo["endpicurl"]); endif; ?>"  width="373px"/> <br />
  					...
  					<br />
  					 <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',1000,500,'<?php echo ($token); ?>')" class="btn btn-primary btn_submit  J_ajax_submit_btn">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a>&nbsp;活动结束图片</div></td>
  				</tr>
  			<tr>
