            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                ...
                <tr>
                  ...
                  <td>
				  <div>招聘设置：<input type="radio" value="1" <?php if($config["zhaopin"] == 1): ?>checked="checked"<?php endif; ?> name="zhaopin"/>开启
				  <input type="radio" value="0" name="zhaopin" <?php if($config["zhaopin"] == 0): ?>checked="checked"<?php endif; ?>/>关闭</div>
                  简历设置：<input type="radio" value="1" <?php if($config["jianli"] == 1): ?>checked="checked"<?php endif; ?> name="jianli"/>开启
				  <input type="radio" value="0" name="jianli" <?php if($config["jianli"] == 0): ?>checked="checked"<?php endif; ?>/>关闭
          
                  </td>
                </tr>
   <tr>
				<tr>
                  <th><span class="red">*</span>微房产：</th>
                  <td>
				  <input type="radio" value="1" <?php if($config["fangchan"] == 1): ?>checked="checked"<?php endif; ?> name="fangchan"/>开启
				  <input type="radio" value="0" name="fangchan" <?php if($config["fangchan"] == 0): ?>checked="checked"<?php endif; ?>/>关闭
                  <span class="red">微房产通知</span>
                  </td>
                </tr>
