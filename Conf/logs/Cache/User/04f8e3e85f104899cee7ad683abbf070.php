...
<!--活动开始-->
<div class="cLineB">
    <h4>编辑<?php echo ($lotteryTypeName); ?>活动开始内容</h4><a href="javascript:history.go(-1);"  class="right btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px" >返回</a>
</div> 
...
<TR>
  ...
  <TD>
	...
	<input type="text" class="px" id="keyword" value="<?php if($vo['keyword'] == ''): echo ($lotteryTypeName); else: echo ($vo["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
...
<TR>
  ...
  <TD>
	<input type="text" class="px" id="title" value="<?php if($vo['title'] == ''): echo ($lotteryTypeName); ?>活动开始了<?php else: echo ($vo["title"]); endif; ?>" name="title" style="width:400px" />
  	<br />
  	请不要多于50字!
  </TD>
  <TR>
  	...
  	<table class="userinfoArea" style=" margin: 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
  		<tbody>
  			<tr>
  				...
  				<td><input type="text" class="px" id="endtite" value="<?php if($vo['endtite'] == ''): echo ($lotteryTypeName); ?>活动已经结束了<?php else: echo ($vo["endtite"]); endif; ?>" name="endtite" style="width:400px" />
  					<br />
  					请不要多于50字! </td>
...
<TR>
<th>&nbsp;</th>
<td><button type="submit" class="btn btn-primary btn_submit  J_ajax_submit_btn" >保存</button>　<a href=""  class="btn">取消</a>　<span class="red"></span></td>
</TBODY>
</TABLE>
