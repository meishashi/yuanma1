...
<td>
<p><?php if($reslist['txt4'] == ''): ?><a class="btnGrayS vm" id="add2" href="javascript:doaddit(2)">添加</a><?php endif; ?>　<a href="javascript:dodelit(1)">删除</a><span class="tooltips"><img src="/tpl/Home/bluesea/common/images/price_help.png" align="absmiddle"><span>                 <font color='red'>如果添加的项想删除,<br/>把[字段名称]\[初始内容]里的值清空<br/>提交即可</font>
                </span></span></p>
</td> </tr>
                                            <tr id="trtxt2" <?php if($reslist['txt4'] == ''): ?>style="display: none"<?php endif; ?> >
                                                ...
                                                <td>
                                                    <p><?php if($reslist['txt5'] == ''): ?><a class="btnGrayS vm" id="add3" href="javascript:doaddit(3)">添加</a><?php endif; ?>　<a href="javascript:dodelit(2)">删除</a> <span class="tooltips"><img src="/tpl/Home/bluesea/common/images/price_help.png" align="absmiddle"><span>                 <font color='red'>如果添加的项想删除,<br/>把[字段名称]\[初始内容]里的值清空<br/>提交即可</font>
                </span></span></p>
                                                </td>
                                            </tr>
                                            <tr id="trtxt3"  <?php if($reslist['txt5'] == ''): ?>style="display: none"<?php endif; ?>>
                                                ...
                                                <td>
                                                    <p><a href="javascript:dodelit(3)">删除</a><span class="tooltips"><img src="/tpl/Home/bluesea/common/images/price_help.png" align="absmiddle"><span>                 <font color='red'>如果添加的项想删除,<br/>把[字段名称]\[初始内容]里的值清空<br/>提交即可</font>
                </span></span></p>
                                                </td>
                                            </tr>
<tr>
     ...
     <td>
         <p></p>
                                            ...
                                            <tr id="strtxt1"  >
                                                ...
                                                <td>
                                                    <p><?php if($reslist['select5'] == ''): ?><a class="btnGrayS vm" id="sadd2" href="javascript:sdoaddit(2)">添加</a><?php endif; ?>　<a href="javascript:sdodelit(1)">删除</a><span class="tooltips"><img src="/tpl/Home/bluesea/common/images/price_help.png" align="absmiddle"><span>                 <font color='red'>如果添加的项想删除,<br/>把[字段名称]\[初始内容]里的值清空<br/>提交即可</font>
                </span></span></p>
                                                </td>
                                            </tr>
                                            <tr id="strtxt2" <?php if($reslist['select5'] == ''): ?>style="display: none"<?php endif; ?>>
                                                ...
                                                <td>
                                                    <p><a href="javascript:sdodelit(2)">删除</a><span class="tooltips"><img src="/tpl/Home/bluesea/common/images/price_help.png" align="absmiddle"><span>                 <font color='red'>如果添加的项想删除,<br/>把[字段名称]\[初始内容]里的值清空<br/>提交即可</font>
                </span></span></p>
                                                </td>
                                            </tr>
                                            <tr>
