...
<?php if(($parentid != '0') and ($parentid != '')): ?><a href="<?php echo U('Store/cats',array('token'=>$token,'parentid'=>$parentCat['parentid']));?>" class="btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px">返回上</a><?php endif; ?>
</form>
</div>
<div class="clr"></div>
</div>
