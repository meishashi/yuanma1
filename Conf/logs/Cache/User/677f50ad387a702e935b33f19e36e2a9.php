...
<body>
  ...
  <a href='<?php echo U('Coupon/add',array('token'=>$token));?>' title='新增优惠券' class='btn btn-primary btn_submit  J_ajax_submit_btn'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增优惠券</a>
              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD>优惠券 <?php echo ($list["id"]); ?></TD>
				   ...
				   <a href="index.php?g=User&m=Coupon&a=sn&id=<?php echo ($list["id"]); ?>&type=3">SN码管理</a> 
											<a href='###' Onclick='javascript:demo("<?php echo U('Demo_img/index',array('id'=>$list['id'],'act'=>'Coupon'));?>");' title="预览">预览</a> 

				   <a href="index.php?g=User&m=Lottery&a=cheat&id=<?php echo ($list["id"]); ?>">作弊</a> 
				   <a href="index.php?g=User&m=Coupon&a=edit&id=<?php echo ($list["id"]); ?>">编辑</a>  
				   <a href="
				   ...
				   <a href="index.php?g=User&m=Coupon&a=del&id=<?php echo ($list["id"]); ?>">删除</a></TD>
