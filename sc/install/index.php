...
//参数设置
define('SOFT_VERSION', '2014版');
define('SOFT_RELEASE', $version);
define('ROOT_PATH', dirname(__FILE__).'/../');//网站根目录
define('SOFT_NAME', '蓝海之蓝blueseaTM独立用户商城'.SOFT_VERSION);
define('DBCHARSET','UTF8');//编码 分为 UTF8 GBK
if (!class_exists('ZipArchive')) {exit('您的服务器不支持php zip 无法安装本程序！');}

//----------------------语言包
$lang = array(
'license'=>'<div class="license"><h1>系统安装协议</h1>
                <p>版权所有 (c)2012-2013 保留所有权利。 </p>
				<p>感谢您选择蓝海之蓝blueseaTM独立用户商城基于 PHP + MySQL   的技术开发，全部源码开放。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
			<strong>一、本授权协议适用且仅适用于 2014 版本，官方对本授权协议的最终解释权。</strong>
			    <p></p>
			<strong>二、协议许可的权利 </strong>
				<p>1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 </p>
				<p>2、您可以在协议规定的约束和限制范围内修改 蓝海之蓝blueseaTM独立用户商城源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 蓝海之蓝blueseaTM独立用户商城，还是部份栏目使用 微信公共平台，在你使用了 蓝海之蓝blueseaTM独立用户商城的网站主页上必须加上 蓝海之蓝blueseaTM独立用户商城。</p>
				<p>4、未经官方许可，禁止在 蓝海之蓝blueseaTM独立用户商城  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装   微信公共平台，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
				<p>4、如果本软件带有其它软件的整合API示范例子包，这些文件版权不属于本软件官方，并且这些文件是没经过授权发布的，请参考相关软件的使用许可合法的使用。</p>
				<p><b>版本最新更新：</b> 2014年3月25日</p>
                <p align=right>BY 蓝海之蓝blueseaTM独立用户商城</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 蓝海之蓝blueseaTM独立用户商城V'.SOFT_VERSION.' 安装程序',
...
'install_succ_remark'=>'<p class=\'nest\'>系统安装完成，请登录蓝海之蓝blueseaTM使用。</p>
',
...
$dirfile_items = array(
    'conf' => array('type' => 'file', 'path' => './data/config/db.php'),
);
...
if (file_exists('../data/install.lock')){
	@header("Content-type: text/html; charset=UTF-8");
	echo "系统已经安装过了，如果要重新安装，那么请删除sc/data/目录下的install.lock文件";
	exit;
}
...
if($method == 'show_license') {//声明
	...
	if($submit) {
		...
		if($confstatus['status']==1){
			...
			//$db->query("INSERT INTO `{$tablepre}user` (`id`, `username`, `password`, `role`, `status`, `remark`, `last_login_time`, `last_login_ip`, `last_location`) VALUES(1, '".$username."', '".$password."', 5, 1, '', 1383453875, '127.0.0.1', '')");
			//新增一个标识文件，用来屏蔽重新安装
	...
	$tablepre = 'weixin_';
	$dbport = '3306';
	$fanli_name = '蓝海之蓝blueseaTM独立用户商城演示站';
...
<meta content="蓝海之蓝blueseaTM独立用户商城" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 蓝海之蓝blueseaTM独立用户商城(c) v2014 2013-2014</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
