...
//服务器异步通知页面路径
$notify_url = "http://".$_SERVER['SERVER_NAME']."/sc/wapapli/notify_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
      //$call_back_url = "http://127.0.0.1:8800/wapapli/call_back_url.php";
$call_back_url = "http://".$_SERVER['SERVER_NAME']."/sc/wapapli/call_back_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数
